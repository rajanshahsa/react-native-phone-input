...
class PhoneNumber {
  ...
  //   // custom logic to prevent user removing country code
  //   if(iso2 && iso2!=""){
  //     let {dialCode}= Country.getCountryDataByCode(iso2);
      
  //   let numberCopy = number.trim().replace(/ /g, '')
  //   let rawNumber = numberCopy.substr(dialCode.length+1) //including + length
